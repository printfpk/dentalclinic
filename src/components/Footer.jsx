    ...
    <footer className="bg-secondary text-slate-300 pt-20 pb-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-2">
              ...
              <span className="text-2xl font-bold text-white tracking-tight">DentCare</span>
            </div>
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center hover:bg-primary transition-colors hover:-translate-y-1 text-white">
          ...
          <div>
            ...
            <ul className="space-y-4">
              {['Home', 'About Us', 'Our Services', 'Testimonials', 'Contact Us'].map((link, i) => (
                <li key={i}>
                  <a href="#" className="hover:text-primary transition-colors text-sm flex items-center gap-2 group">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li className="flex items-start gap-3 group">
                <div className="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center shrink-0 group-hover:bg-primary transition-colors">
                  <MapPin className="w-4 h-4 text-primary group-hover:text-white transition-colors" />
                </div>
                <span className="pt-1">123 Dental Street, Healthcare City, NY 10001</span>
              </li>
        ...
        <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-sm">
          <p>© 2026 DentCare. All rights reserved.</p>
